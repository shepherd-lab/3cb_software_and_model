function  UKComputeBreastDensity(Innerline,ROI, Image)
    ...
    Analysis.Fat_ref = klean_thick*(Vph80_thick + (1/km-1)*(ph80_a2 * thickness.^2 + ph80_a1 * thickness));
   ...
   %Fat_ref_ROI = klean_ROI*(Vph80_ROI + (1./km_ROI-1)* (Vph80_ROI - ph_offset));    %(ph80_a2 * thickness.^2 + ph80_a1 * thickness));
    ...
    Fat_ref_ROI = ph_a2fat * thickness_ROI.^2 +  ph_a1fat * thickness_ROI + ph_offsetcorr; 
