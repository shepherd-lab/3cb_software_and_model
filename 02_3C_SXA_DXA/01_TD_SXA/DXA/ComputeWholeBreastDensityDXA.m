...
global BreastMask MaskROIproj Outline BreastMaskManual thickness_mapproj DXAAnalysis SXAAnalysis
...
if get(ctrl.CheckAutoSkin,'value')
    ...
    %% Material image
    DXAroi_materialManual = funcclim(Image.material(ROI.ymin:ROI.ymin+ROI.rows-1,ROI.xmin:ROI.xmin+ROI.columns-1).*BreastMaskManual,0,100);
