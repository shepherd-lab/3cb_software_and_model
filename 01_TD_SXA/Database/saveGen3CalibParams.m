...
if  Info.CheckKtableGen3==false
    ...
    % % % if Analysis.Ibkg<0
    % % %
    % % %     Analysis.Ibkg =Analysis.Ibkg +1500;   % Real value of background for negative background
    % % % end;
    Analysis.Ibkg=Analysis.Ibkg
    ...
    entryWrite{57} = num2str(Info.roi_QCWAX_status);
    %write table by checking existance according to acquistion_id and version
