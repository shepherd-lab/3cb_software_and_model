...
global dummyuicontrol2 ctrl f0  Analysis Image ROI VidarQAData %QCAnalysisData

%Analysis.GammaDSP = false; 
%k = 150 / 169;
k = 1;
VidarQAData.Draw.MainBox=[1182,1381] * k;
VidarQAData.Draw.Compartments=32;
VidarQAData.Draw.BorderY= 30 * k;
VidarQAData.Draw.BorderX=400 * k;
VidarQAData.Output = zeros(VidarQAData.Draw.Compartments,2);
VidarQAData.Output(:,1) = [0.06;0.11;0.19;0.28;0.38;0.48;0.59;0.71;0.82;0.93;1.03;1.13;1.23;1.37;...
   1.48;1.61;1.72;1.83;1.96;2.1;2.22;2.32;2.43;2.59;2.72;2.87;3.01;3.16;3.32;3.48;3.63;3.78];
...
switch RequestedAction
    ...
    case 'InitDrawing'
        ...
        for index=1:VidarQAData.Draw.Compartments
            VidarQAData.Box(index)=plot(0,0,'g','linewidth',1);
        end
    ...
    case 'compute'
        ...
        for index=1:VidarQAData.Draw.Compartments
            ...
            ROI.ymax=floor(y1+(y2-y1)/(VidarQAData.Draw.Compartments)*(index-1)+VidarQAData.Draw.BorderY);
            ROI.ymin=floor(y1+(y2-y1)/(VidarQAData.Draw.Compartments)*(index)-VidarQAData.Draw.BorderY);
            ROI.rows=ROI.ymax-ROI.ymin+1;
            ROI.columns=ROI.xmax-ROI.xmin+1;
            VidarQAData.Output(index,2) = mean(mean(Image.image(ROI.ymin:ROI.ymax,ROI.xmin:ROI.xmax)));  
        end
