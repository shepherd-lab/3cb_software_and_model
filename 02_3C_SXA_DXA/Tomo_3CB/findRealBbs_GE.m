function [BBcoord, group] = findRealBbs_GE(coordAll)
...
group = groupingPairs_GE(coordAll);
...
BBcoord(1, :) = group(7).coord(1, :);
BBcoord(3, :) = group(7).coord(2, :);
BBcoord(2, :) = group(6).coord(1, :);
BBcoord(4, :) = group(6).coord(2, :);
BBcoord(13, :) = group(5).coord(1, :);
BBcoord(14, :) = group(5).coord(2, :);
