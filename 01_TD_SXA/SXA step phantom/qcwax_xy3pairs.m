function [sort_coord] = rm1_bbspos_leftsmall()
    global Image figuretodraw coord Info Analysis Error ctrl %h_init 
  ...
  % axes;
   ...
   % xy_centroids(1:ln,1:2) = [stats2(1:ln).Centroid(1)+690,stats2(1:ln).Centroid(2)-50]; 
    ...
    Line4.y2 = coord(14,2);
     ...
     %figuretodraw; hold on; plot([Line5.x0 Line5.x2],[Line5.y0 Line5.y2],'Linewidth',1,'color','b');
