function sxa_acq_extraction()
  global database fname Info
    ...
    sz1 = size(ACQIDList);
    len = sz1(1);
    dir_towrite = '\\researchstg\aaData\Breast Studies\Masking\Source_png_mat_files\UCSF\';
    dir_towrite_pres = '\\researchstg\aaData\Breast Studies\Masking\Source_png_mat_files\UCSF\Presentation';
     key = 0;
     count = 0;
     count2=0;
    for index=1:len
