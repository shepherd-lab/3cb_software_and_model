%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function QCAnalysis_DXA(RequestedAction)%GammaROI
    ...
    case 'compute'
       % set(ctrl.CheckBreast,'value',true);
        ...
        for y_index=1:7
         ...
         phantom_values2 = reshape(phantom_values,28,1);
