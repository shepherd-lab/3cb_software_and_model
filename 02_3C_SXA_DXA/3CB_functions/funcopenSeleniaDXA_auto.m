function funcopenSeleniaDXA_auto(lehe_fnames,calibration_type)
    ...
    clear_DXAfields;
    fname =lehe_fnames.LEfname;
    funcMenuOpenImage_auto(fname,Option); % open the LE image
    Result.flagHE = true;
    option = Result.DXASelenia;
    fname =lehe_fnames.HEfname;
    funcMenuOpenImage_auto(fname,option); % open the HE image
    SXAAnalysis = [];
    DXAAnalysis = [];
    MaskROIproj = [];
    BreastMask = [];
