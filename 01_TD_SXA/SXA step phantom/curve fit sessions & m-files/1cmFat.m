function 1cmFat(fatThickness,fatValues,leanThickness,leanValues)
%1CMFAT    Create plot of datasets and fits
%   1CMFAT(FATTHICKNESS,FATVALUES,LEANTHICKNESS,LEANVALUES)
...
%    Unweighted
%
% This function was automatically generated on 03-May-2005 15:28:43
...
st_ = [62000 0.3712716439639 0.4972273630947 0.8029785604752 ];
...
if 0
   cv_ = {61506.05984065, -2.112266605206, 0.9635176172218, -456287.9982949};
   cf_ = cfit(ft_,cv_{:});
end
...
% --- Create fit "leanFit"
fo_ = fitoptions('method','NonlinearLeastSquares','Lower',[60000  -Inf  -Inf  -Inf ],'Upper',[63000 Inf Inf Inf ]);
...
% Or use coefficients from the original fit:
if 0
   cv_ = {61371.44569488, -1.914645294104, 0.5085559731397, -3297720.56648};
   cf_ = cfit(ft_,cv_{:});
end
