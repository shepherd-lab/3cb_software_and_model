...
elseif strcmp(RequestedAction,'ShowThickness')
    ...
    elseif strcmp(RequestedAction,'ShowMaterial')
    %ReinitImage(Image.Material,'OPTIMIZEHIST');
    ShowDXAImage('2DMATERIAL');
elseif strcmp(RequestedAction,'ShowThickness')
    %ReinitImage(Image.Material,'OPTIMIZEHIST');
    ShowDXAImage('2DTHICKNESS');
elseif strcmp(RequestedAction,'ShowThirdComponent')
    %ReinitImage(Image.Material,'OPTIMIZEHIST');
    ShowDXAImage('ThirdComponent');
elseif strcmp(RequestedAction,'ShowDensevolume')
    ShowDXAImage('DENSEVOLUME');
elseif strcmp(RequestedAction,'ShowTMASK3C')
    ShowDXAImage('TMASK3C');
end
