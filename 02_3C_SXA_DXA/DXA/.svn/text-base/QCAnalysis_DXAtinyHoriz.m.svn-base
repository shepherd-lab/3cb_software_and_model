...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function QCAnalysis_DXAtinyHoriz(RequestedAction)% Tiny Phantom Horizontal
global dummyuicontrol2 f0 PhantomRefData  Image ROI

n1=4; % number of columns
n2=3; % number of lines

phantom_values = zeros(n1,n2); %ROI numbers, here 3 by 4.

PhantomRefData.LengthY = 15; % Lenght of the ROI on axis Y
PhantomRefData.LengthX = 65;
PhantomRefData.Draw.Compartments=n1*n2;
PhantomRefData.Draw.BorderX= 105;
PhantomRefData.Draw.BorderY= 55;
...
switch RequestedAction
    ...
    case 'Redraw'
        ...
        x2=PhantomRefData.x0+PhantomRefData.Draw.MainBox(1)+36; % +36 is for the edge of the box
        ...
        for y_index=1:n2
            for x_index=1:n1
                X1=x1+PhantomRefData.Draw.BorderX*(x_index-1)+18;
    ...
    case 'compute'
        ...
        for y_index=1:n2 % repetition of rederaw parameters
            for x_index=1:n1
                ROI.X1=x1+PhantomRefData.Draw.BorderX*(x_index-1)+18;
        ...
        phantom_values2(:,3) = reshape(phantom_values,n1*n2,1);
        density_vect = repmat([0 50 80 100],1,n2);
