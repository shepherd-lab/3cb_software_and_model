...
global CalibrationPoints Data2 Data3 Data;
...
MinRST=min(Data3(:,4))-0.1; % automatic choice of the scale
MaxRST=max(Data3(:,4))+0.1; 

MinHE=min(Data3(:,3))-2000;
MaxHE=max(Data3(:,3))+2000;
