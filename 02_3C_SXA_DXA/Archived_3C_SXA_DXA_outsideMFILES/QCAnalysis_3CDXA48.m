%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function QCAnalysis_3CDXA48(RequestedAction)%GammaROI
...
switch RequestedAction
    ...
    case 'ROOT'
        QCAnalysis_3CDXA48('InitDrawing');
        set(f0.handle,'WindowButtonMotionFcn','QCAnalysis_3CDXA48(''Motion'')','WindowButtonDownFcn','nextpatient(1);');
...
% % % %          
       % [fname,pname]=uiputfile('\\researchstg\aaData\Breast Studies\3C_data\RO1_3Cimages\UCSF\*.txt');
        ...
        fname = ['Calibration_',name,'WLT_rambled.txt'];
