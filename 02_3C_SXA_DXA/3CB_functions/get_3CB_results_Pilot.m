...
disp('*******************************************************');
file_names = fuf(strcat(parentDir,'\*_3CB_Analysis_Results.mat'),1,'detail');
...
for ii = 1:1:num_files
    ...
    patient_num = filename_end(10:slash_ind-1);
    disp(['Patient Number: ' patient_num]);
%     patientNums{ii} = patient_num;
    filename_towrite = [dir_towrite,patient_num,'_CC','_WLP.mat'];
