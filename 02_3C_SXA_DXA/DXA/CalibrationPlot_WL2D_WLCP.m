...
global X X2 X3 Result4;
global CalibrationPoints Data2 Data;
...
plot(Data(:,4),Data(:,3),'*','markersize',7,'markerfacecolor','blue','markeredgecolor','blue'); hold on;
...
MinRST=min(Data2(:,4))-0.1; % automatic choice of the scale
MaxRST=max(Data2(:,4))+0.1; 

MinHE=min(Data2(:,3))-2000;
MaxHE=max(Data2(:,3))+2000;
