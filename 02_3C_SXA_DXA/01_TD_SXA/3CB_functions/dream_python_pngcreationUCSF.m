...
%   image = Image.OriginalImageInit;
    pres_image = Result.image2;  
%     Image.image = pres_image;
%     figure;imagesc(pres_image);colormap(gray);
%     ReinitImage(pres_image,'OPTIMIZEHIST');
%     
