...
% % %                       ' WHERE (dbo.sxastepanalysis.sxa_analysis_date LIKE ''%Dec-2012%'') and (dbo.acquisition.film_identifier like ''%Marsden_11-07-2012%'')  AND dbo.acquisition.acquisition_id =' ,num2str(1000876701),...
...
% %                     '  ORDER BY dbo.sxastepanalysis.sxa_analysis_date'];
                 ...
                 SQLStatement =['SELECT *  FROM dbo.acquisition',...
                     ' WHERE (dbo.acquisition.film_identifier like ''%Marsden_11-07-2012%'' AND (view_id = 2 OR  view_id = 3)) ',...
                    '  ORDER BY dbo.acquisition.acquisition_id']           
