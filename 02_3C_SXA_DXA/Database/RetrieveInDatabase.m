...
%% FILE OF LISTNAMES
    case 'FILEOFLISTNAMES'
     ...
     %orig: [FileName,PathName] = uigetfile('\\researchstg\aaDATA\Breast Studies\*.txt','Select the acquisition list txt-file ');     
     [FileName,PathName] = uigetfile('O:\SRL\aaData\Breast Studies\*.txt','Select the acquisition list txt-file '); %051718 sypks
...
%% Acquisition
 ...
 %  replaced 051718 sypks               
 %~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~OLD UCSF DIRECTORIES~~~~~~~~~~~~~~~~~~~~~~~
%                 if date_acq_num > date_driveN
%                     start_dir = '\\researchstg\aaDATA8\Lucyz-Desktop\Breast Studies\CPMC\DicomImagesBlinded(digi)';
%                     startdir_report = '\\researchstg\aaDATA8\Lucyz-Desktop\Breast Studies\CPMC';
%                 elseif date_acq_num > date_driveK
