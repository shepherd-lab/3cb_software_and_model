...
% % %            end
        ...
        elseif  (strfind(view, 'ML') & (kvp == 39 | kvp == 38) & strfind(mode, 'TEC'))
            file_short = 'HEMLTEC';
        elseif strfind(mode, 'MANUAL')
            if ((kvp==25 ) & (mas>49 && mas<51)) % & thickness == 126 % & paddle(1:4)~= uint8([78;111;110;101]) %
                file_short = 'DC';
            elseif ((kvp == 39 | kvp == 38) & (paddle(1:4) == uint8([50;52;99;109]) | paddle(1:4) == uint8([49;56;32;99])) | (paddle(1:4) == uint8([78;111;110;101])  & thickness < 110) )   %;109
                file_short = 'CPHE';
              
            elseif ((kvp~= 39 & kvp ~= 38) & (paddle(1:4) == uint8([50;52;99;109]) | paddle(1:4) == uint8([49;56;32;99])) & (thickness >= 74 & thickness <= 130)) % | paddle(1:4) == uint8([78;111;110;101])       0&  (thickness > 84 & time > 735500)
                file_short = ['CPLE',num2str(kvp)];
               THIKNESS_ =  thickness
            elseif ((kvp~= 39 & kvp ~= 38) & (paddle(1:4) == uint8([50;52;99;109]) | paddle(1:4) == uint8([49;56;32;99])) & ((thickness < 74))) % & time > 735500) | (thickness < 70 & time < 735500)
                file_short = ['GEN3',num2str(kvp),num2str(force)];
% %             elseif ((kvp~= 39 | kvp ~= 38) & (paddle(1:4) == uint8([50;52;99;109]) | paddle(1:4) == uint8([49;56;32;99])) & (thickness >70)) % & time < 735500
% %                          file_short = ['CPLE',num2str(kvp)];             
            elseif ((kvp == 39 | kvp == 38) & paddle(1:4) == uint8([78;111;110;101]))
                file_short = 'FFHE';
            elseif ((kvp ~= 39 & kvp ~= 38) & paddle(1:4) == uint8([78;111;110;101]))% & thickness > 129
                file_short = ['FFLE',num2str(kvp)];
...
%%%%        creation names for saving mat and png files
          if ~isfield(info_dicom,'StationName')
              info_dicom.StationName = 'Moffitt';
          end
           mode = info_dicom.ExposureControlMode;
           thickness = info_dicom.BodyPartThickness;
           paddle = uint8(info_dicom.Private_0019_1026);
...
% %                  
      ...
      if strfind(view, 'CC') & strfind(mode, 'AUTO_FILTER')
        ...
        elseif  (strfind(view, 'ML') & (kvp == 39 | kvp == 38) & strfind(mode, 'TEC'))
            file_short = 'HEMLTEC';
        elseif strfind(mode, 'MANUAL')
            if (kvp==25 & (mas>49 && mas<51))%& paddle(1:4) ~= uint8([78;111;110;101]))
                file_short = 'DC';
            elseif ((kvp == 39 | kvp == 38) & (paddle(1:4) == uint8([50;52;99;109]) | paddle(1:4) == uint8([49;56;32;99]) | paddle(1:4) == uint8([78;111;110;101])) ) %;109
                file_short = 'CPHE';
              
            elseif ((kvp~= 39 | kvp ~= 38) & (paddle(1:4) == uint8([50;52;99;109]) | paddle(1:4) == uint8([49;56;32;99]) | paddle(1:4) == uint8([78;111;110;101])) & (thickness >= 74 & thickness <= 130)) %& (thickness > 84 & time > 735500)
%                 ((kvp~= 39 | kvp ~= 38) & (paddle(1:4) == uint8([50;52;99;109]) | paddle(1:4) == uint8([49;56;32;99]) | paddle(1:4) == uint8([78;111;110;101])) & thickness >= 74 ) %& (thickness > 84 & time > 735500)
                file_short = ['CPLE',num2str(kvp)];
            elseif ((kvp~= 39 | kvp ~= 38) & (paddle(1:4) == uint8([50;52;99;109]) | paddle(1:4) == uint8([49;56;32;99])) & ((thickness < 74))) % & time > 735500) | (thickness < 70 & time < 735500)
                file_short = ['GEN3',num2str(kvp)];
% %             elseif ((kvp~= 39 | kvp ~= 38) & (paddle(1:4) == uint8([50;52;99;109]) | paddle(1:4) == uint8([49;56;32;99])) & (thickness >70)) % & time < 735500
