function dicom3C_redirectionUCSF(pat_min, pat_max)
%Purpose - transfer DICOMs to UCSF_Dicoms folder 
%Input parameters - numerical patient number
global ctrl
  parentdir = uigetdir('\\researchstg\aaStudies\Breast Studies\3CB R01\Source Data\Bovine_experiment\E11120151218');
...
% % %                folder = 'UCSF\3C01035';
% % %            elseif strcmp(info_dicom.AcquisitionDate,'20140414')
% % %                folder = 'UCSF\3C01036';
...
% % %                folder = 'UCSF\3C01060';    
% % %            if strcmp(info_dicom.AcquisitionDate,'20140813')
% % %                folder = 'UCSF\3C01061';  
% % %             elseif strcmp(info_dicom.AcquisitionDate,'20140814')
% % %                folder = 'UCSF\3C01062';     
% % %             elseif strcmp(info_dicom.AcquisitionDate,'20140818')
% % %                folder = 'UCSF\3C01063';   
% % %             elseif strcmp(info_dicom.AcquisitionDate,'20140819')
% % %                folder = 'UCSF\3C01064';  
% % %             elseif strcmp(info_dicom.AcquisitionDate,'20140905')
% % %                folder = 'UCSF\3C01065';  
% % %             elseif strcmp(info_dicom.AcquisitionDate,'20140909')
% % %                folder = 'UCSF\3C01066';  
% % %             elseif strcmp(info_dicom.AcquisitionDate,'20140911')
% % %                folder = 'UCSF\3C01067';  
% % %             elseif strcmp(info_dicom.AcquisitionDate,'20140918')
% % %                folder = 'UCSF\3C01068';  
% % %             elseif strcmp(info_dicom.AcquisitionDate,'20140924')
% % %                folder = 'UCSF\3C01069';     
% % %             elseif strcmp(info_dicom.AcquisitionDate,'20141002')
% % %                folder = 'UCSF\3C01070';      
% % %             elseif strcmp(info_dicom.AcquisitionDate,'20141002')
% % %                folder = 'UCSF\3C01071';  
% % %             elseif strcmp(info_dicom.AcquisitionDate,'20141013')
% % %                folder = 'UCSF\3C01072';  
% % %             elseif strcmp(info_dicom.AcquisitionDate,'20141014')
% % %                folder = 'UCSF\3C01073';  
% % %             elseif strcmp(info_dicom.AcquisitionDate,'20141014')
% % %                folder = 'UCSF\3C01074';  
% % %             elseif strcmp(info_dicom.AcquisitionDate,'20141016')
% % %                folder = 'UCSF\3C01075';  
% % %             elseif strcmp(info_dicom.AcquisitionDate,'20141016')
% % %                folder = 'UCSF\3C01076';  
% % %             elseif strcmp(info_dicom.AcquisitionDate,'20141016')
% % %                folder = 'UCSF\3C01077';  
% % %             elseif strcmp(info_dicom.AcquisitionDate,'20141020')
% % %                folder = 'UCSF\3C01078';  
% % %             elseif strcmp(info_dicom.AcquisitionDate,'20141103')
% % % % % % % %                folder = 'UCSF\3C01079'; 
% % % % %             filename_read
% % % % %             k
% % % % %            kstr = strfind(filename_read,'E3C01')
% % % % %            kstr2 = strfind(filename_read,'E3C111111')
% % % % %            if ~isempty(kstr)
