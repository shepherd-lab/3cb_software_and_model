...
%% Density
        if ~Error.PhantomDetection
            ...
            eval(CallBack);
            mxDatabase(Database.Name,['update sxaanalysis set sxaresult=''',num2str(Analysis.DensityPercentage),''' where sxaanalysis_id=',num2str(Info.SXAAnalysisKey)]);
        end
