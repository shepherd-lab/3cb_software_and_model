function  Analysis = Z4ComputePhantomDensity(ROI,Image,Analysis)
         
        global Info bb Analysis params roi_values Error h_slope Z4coef_table  MachineParams thickness_ROI  Database%ROI
               
       % temproi=Image.image(ROI.ymin:ROI.ymin+ROI.rows-1,ROI.xmin:ROI.xmin+ROI.columns-1);
       %thickness of the phantom % 107083
       thickness = 4.012; 
