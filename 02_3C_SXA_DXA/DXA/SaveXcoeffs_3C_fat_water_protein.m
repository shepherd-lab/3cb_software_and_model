function SaveXcoeffs_3C_fat_water_protein(type)
global X patient_ID file Image Info

% Calculate the coefficients ci and di in X=[coeff2 coeff]
% from the Calibration Points.
Info.type3C = type;
dir_towrite = '\\researchstg\aaStudies\Breast Studies\3CB R01\Source Data\Bovine_experiment\Calibration_Bovine_Serghei\Bovine_234567cm_calibration\Calibration_Xcoeffs\';
[fileName, pathName]=uigetfile('\\researchstg\aaStudies\Breast Studies\3CB R01\Source Data\Bovine_experiment\Calibration_Bovine_Serghei\Bovine_234567cm_calibration\*.txt', 'Please select calibration file.');
