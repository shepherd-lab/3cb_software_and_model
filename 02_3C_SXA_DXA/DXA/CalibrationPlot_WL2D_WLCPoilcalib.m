...
plot(Data(:,4),Data(:,3),'o','markersize',3,'markerfacecolor','blue','markeredgecolor','blue'); hold on;
...
MinRST=min(Data(:,3))-0.1; % automatic choice of the scale
MaxRST=max(Data(:,3))+0.1; 

MinHE=min(Data(:,4))-2000;
MaxHE=max(Data(:,4))+2000;
