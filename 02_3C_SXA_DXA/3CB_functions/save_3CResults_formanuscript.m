...
%------------- BEGIN CODE --------------
function save_3CResults_fomanuscript()
...
maps.results
output = [maps.results.ROIW; maps.results.ROIL; maps.results.ROIP;maps.results.breastW;maps.results.breastL;maps.results.breastP]
   pfname = '\\researchstg\aaStudies\Breast Studies\3CB R01\Source Data\Bovine_experiment\Calibration_Bovine_CP51\';
%           pfname = '\\researchstg\aaStudies\Breast Studies\3CB R01\Source Data\Bovine_experiment\Calibration_Bovine_Serghei\';
fname_results = [pfname,fname];
save(fname_results,'maps');
