...
bb1circle = estimateCircle(contour);

% display the calculated center
hold on;
if DEBUG plot(bb1circle.x,bb1circle.y,'yx','LineWidth',2);end

%write the calculated output
Phantom(1).mx=bb1circle.x + y/2;  %adjust to the orginal image size  
Phantom(1).my=bb1circle.y;
...
if DEBUG
theta = 0:0.01:2*pi;
Xfit = bb1circle.r*cos(theta) + bb1circle.x;
Yfit = bb1circle.r*sin(theta) + bb1circle.y;
hold on;
plot(Xfit, Yfit);
end
...
%hold on
if DEBUG plot(contour(:,2),contour(:,1),'g','LineWidth',2);end
bb2circle = estimateCircle(contour);

% display the calculated center
hold on;
if DEBUG plot(bb2circle.x,bb2circle.y,'yx','LineWidth',2);end

%write the calculated output
Phantom(2).mx=bb2circle.x + y/2;  %adjust to the orginal image size  
Phantom(2).my=bb2circle.y;
...
%hold on
if DEBUG plot(contour(:,2),contour(:,1),'g','LineWidth',2);end
bb3circle = estimateCircle(contour);

% display the calculated center
hold on;
if DEBUG plot(bb3circle.x,bb3circle.y,'yx','LineWidth',2);end

%write the calculated output
Phantom(3).mx=bb3circle.x + y/2;  %adjust to the orginal image size  
Phantom(3).my=bb3circle.y;

%detecting bb #5
row = row + 2;
offset = round(bb3circle.x)+15;
...
%hold on
if DEBUG plot(contour(:,2),contour(:,1),'g','LineWidth',2);end
bb5circle = estimateCircle(contour);

% display the calculated center
hold on;
if DEBUG plot(bb5circle.x,bb5circle.y,'yx','LineWidth',2);end

%write the calculated output
Phantom(5).mx=bb5circle.x + y/2;  %adjust to the orginal image size  
Phantom(5).my=bb5circle.y;
...
%hold on
if DEBUG plot(contour(:,2),contour(:,1),'g','LineWidth',2);end
bb6circle = estimateCircle(contour);

% display the calculated center
hold on;
if DEBUG plot(bb6circle.x,bb6circle.y,'yx','LineWidth',2);end

%write the calculated output
Phantom(6).mx=bb6circle.x + y/2;  %adjust to the orginal image size  
Phantom(6).my=bb6circle.y;

%detecting bb #4
row = row - 2;
offset = round(bb6circle.x)+150;
...
%hold on
if DEBUG plot(contour(:,2),contour(:,1),'g','LineWidth',2);end
bb4circle = estimateCircle(contour);

% display the calculated center
hold on;
if DEBUG plot(bb4circle.x,bb4circle.y,'yx','LineWidth',2);end

%write the calculated output
Phantom(5).mx=bb4circle.x + y/2;  %adjust to the orginal image size  
Phantom(5).my=bb4circle.y;
