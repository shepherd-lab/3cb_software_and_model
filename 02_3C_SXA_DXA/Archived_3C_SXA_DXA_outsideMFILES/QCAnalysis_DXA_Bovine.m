%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function QCAnalysis_DXA_Bovine(RequestedAction)%GammaROI
...
switch RequestedAction
    ...
    case 'ROOT'
        QCAnalysis_DXA_Bovine('InitDrawing');
