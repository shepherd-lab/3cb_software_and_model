...
for i=[203:2206]
    %       for i=[164:164]
    parentdir = ['\\researchstg\aaData\Breast Studies\3C_data\RO1_3Cimages\UCSF\UCSF_DICOMs\E3C01',num2str(i,'%03.0f')];
    outputdir = '\\researchstg\aaData\Breast Studies\iCAD\DICOM_images\ForProcessing\';
    outputdir_pres = '\\researchstg\aaData\Breast Studies\iCAD\DICOM_images\ForPresentation\';
