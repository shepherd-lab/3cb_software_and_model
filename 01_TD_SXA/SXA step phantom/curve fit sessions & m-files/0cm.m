function 0cm(fatThickness,fatValues,leanThickness,leanValues)
%0CM    Create plot of datasets and fits
%   0CM(FATTHICKNESS,FATVALUES,LEANTHICKNESS,LEANVALUES)
...
%    Unweighted
%
% This function was automatically generated on 03-May-2005 13:50:53

% Set up figure to receive datasets and fits
f_ = clf;
figure(f_);
set(f_,'Units','Pixels','Position',[398 163 680 484]);
...
% --- Create fit "fatFit"
fo_ = fitoptions('method','NonlinearLeastSquares','Lower',[60000  -Inf  -Inf  -Inf ],'Upper',[62000 Inf Inf Inf ]);
ok_ = ~(isnan(fatThickness) | isnan(fatValues));
st_ = [61000 0.5910262034395 0.1153702330452 0.6533870229827 ];
...
if 0
   cv_ = {61339.51206651, 3.21880988785, 0.3758048777712, 42217.29041337};
   cf_ = cfit(ft_,cv_{:});
end
...
% Or use coefficients from the original fit:
if 0
   cv_ = {61370.00935198, 0.09260933997165, 0.4614169062336, -35968.9240975};
   cf_ = cfit(ft_,cv_{:});
end
