...
if Info.UseSuperFatLeanImage
  ...
  Analysis.Height1 = 40;
   ...
   Hleancorr = 43 * tan(-Phantom.AngleHoriz * 1.1 * 6.28 /360) + 1
   
   %2800 (Hfatcorr +
   height3 = Analysis.PhantomFatRefHeight
   Hfat_ROI  = (Analysis.coordXFatcenter-slope_roi)*(1 - (Analysis.PhantomFatRefHeight/600) * tan(-Phantom.AngleHoriz *1.1 * 6.28 /360) )* 0.15;
