%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function QCAnalysis_3CDXA(RequestedAction)%GammaROI
...
switch RequestedAction
    ...
    case 'ROOT'
        QCAnalysis_3CDXA('InitDrawing');
        set(f0.handle,'WindowButtonMotionFcn','QCAnalysis_3CDXA(''Motion'')','WindowButtonDownFcn','nextpatient(1);');
...
% % % %          
       % [fname,pname]=uiputfile('\\researchstg\aaData\Breast Studies\3C_data\RO1_3Cimages\UCSF\*.txt');
        ...
        fname = ['Calibration48point_',name,'right.txt'];
