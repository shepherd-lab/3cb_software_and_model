function [image_freeform,chestwall_Mask]=excludePCmuscle(CurrentImage)
...
% SQLstatement=['SELECT commonanalysis.commonanalysis_id, commonanalysis.ChestWall_ID FROM [mammo_CPMC].[dbo].[acquisition],[mammo_CPMC].[dbo].[commonanalysis]   WHERE acquisition.acquisition_id = commonanalysis.acquisition_id  AND commonanalysis.acquisition_id =', num2str(Info.AcquisitionKey)]; 

SQLstatement=['SELECT commonanalysis.commonanalysis_id, commonanalysis.ChestWall_ID FROM acquisition, commonanalysis   WHERE acquisition.acquisition_id = commonanalysis.acquisition_id  AND commonanalysis.acquisition_id =', num2str(Info.AcquisitionKey)]; 
