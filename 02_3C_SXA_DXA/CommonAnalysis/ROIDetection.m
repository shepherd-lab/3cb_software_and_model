...
function Output=funcCleanBackGround(Image)
    ...
    Analysis.BackGroundThreshold = double(Analysis.BackGroundThreshold);
    ...
    if isfield(Image,'LE')
       ...
       Output=Image.OriginalImage+(double(Analysis.BackGround)|(Image.OriginalImage<Analysis.BackGroundThreshold)).*(-Image.OriginalImage+Analysis.BackGroundThreshold); 
    end
