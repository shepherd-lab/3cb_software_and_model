...
% %       
      SQLStatement =['SELECT dbo.acquisition.*, dbo.sxastepanalysis.*, dbo.OtherSXAStepInfo.*',... 
                    ...
                    ' WHERE (dbo.acquisition.film_identifier like ''%Marsden_11-07-2012%'') and dbo.sxastepanalysis.run_number = 11 AND dbo.acquisition.acquisition_id =' ,num2str(ACQIDList(index)),...
...
% %                     '  ORDER BY dbo.sxastepanalysis.sxa_analysis_date'];
     ...
     for index=2:size(ACQIDList,1)
      ...
      SQLStatement =['SELECT dbo.acquisition.*, dbo.sxastepanalysis.*, dbo.OtherSXAStepInfo.*',... 
                   ...
                   % ' WHERE (film_identifier like ''%Marsden_11-07-2012%'') and run_number = 11 AND dbo.acquisition.acquisition_id =' ,num2str(ACQIDList(index)),...
                   % '  ORDER BY dbo.sxastepanalysis.sxa_analysis_date'];
