...
fat_deltamax=max(abs(Data(:,1)-Result(:,1)))
...
mean(Data(:,1)-Result(:,1))
mean(Data(:,2)-Result(:,2))
mean(Data_protein-Result_protein)

median(Data(:,1)-Result(:,1))
median(Data(:,2)-Result(:,2))
median(Data_protein-Result_protein)
...
ylabel('Thickness protein','fontsize',14);xlabel('t_w/(t_w+t_f)','fontsize',14); grid on;
legend('Calculted thickness','Real thickness');

figure;plot(g,Result(:,1),'o');hold on;  %blue 'o' - calculated data 
plot(g,Data(:,1),'rx');                  %red  'x' - real data
ylabel('Thickness fat','fontsize',14);xlabel('t_w/(t_w+t_f)','fontsize',14); grid on;
legend('Calculted thickness','Real thickness');
...
% 
% 
% figure; plot(fg(19:24),(Result(19:24,1)-Data(19:24,1))./Data(19:24,1)*100,'^');hold on;
...
figure;
plot(fg(25:26),Result(25:26,1),'ko');hold on;
...
figure;
plot(fg(25:26),Result(25:26,2),'ko');hold on;
...
figure;
plot(fg(25:26),Result_protein(25:26),'ko');hold on;
