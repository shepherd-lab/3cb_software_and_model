        ...
        for index=2:QCAnalysisData.Draw.Compartments-1
         ...
         % Analysis.DensityPercentage = [];
          elseif Info.DigitizerId >= 4
            ...
            DensityResults{index,1}=Analysis.DensityPercentage';
        end
