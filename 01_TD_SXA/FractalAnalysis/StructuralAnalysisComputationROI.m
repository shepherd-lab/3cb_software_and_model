...
StructuralAnalysis.StructuralAnalysisType = 2;
StructuralAnalysis.CancerRegionID = CancerRegionData.ID;
Error.PC=false;
...
%     im2 = CurrentImage(index2);
   ...
   %figure;imagesc(FractalCurrentImage); colormap(gray);
    ...
    for indexFractalThreshold=1:17
        p = polyfit(xfd,FD_Th(:,indexFractalThreshold)',1);
