function  ROI9step_calculation2(film_small)
    ...
    bb0(1).x = 0.2;                   bb0(1).y = (1.5*roi_ysize);                  bb0(1).z = 0;
    bb0(2).x = -(3*roi_xsize)-0.3;     bb0(2).y = (1.5*roi_ysize);                  bb0(2).z = 0;
    bb0(3).x = -(3*roi_xsize)-0.3;     bb0(3).y = -(1.5*roi_ysize)-bb9(1).z*m;      bb0(3).z = 0;
    bb0(4).x = -(2*roi_xsize);         bb0(4).y = -(1.5*roi_ysize)-bb9(1).z*m;;     bb0(4).z = 0;   
    bb0(5).x = -(2*roi_xsize);         bb0(5).y = -(1.5*roi_ysize)-bb8(1).z*m;;     bb0(5).z = 0; 
    bb0(6).x = -(roi_xsize);           bb0(6).y = -(1.5*roi_ysize)-bb8(1).z*m;;     bb0(6).z = 0;
    bb0(7).x = -(roi_xsize);           bb0(7).y = -(1.5*roi_ysize)-bb7(1).z*m;;     bb0(7).z = 0;
    bb0(8).x = 0.2;                   bb0(8).y = -(1.5*roi_ysize)-bb7(1).z*m;;     bb0(8).z = 0;
 ...
 %{
  ...
  %}
   ...
   %
    ...
    plot([bb.bb0(1).x, bb.bb0(2).x, bb.bb0(3).x, bb.bb0(4).x,bb.bb0(5).x  ],[bb.bb0(1).y, bb.bb0(2).y, bb.bb0(3).y, bb.bb0(4).y,bb.bb0(5).x ],'r'); hold on;
    plot([bb.bb0(5).x, bb.bb0(6).x, bb.bb0(7).x, bb.bb0(8).x,bb.bb0(1).x ],[bb.bb0(5).y, bb.bb0(6).y, bb.bb0(7).y, bb.bb0(8).y,bb.bb0(1).y],'r'); 
    % plot([bb.bbB(1).x, bb.bbB(2).x, bb.bbB(3).x, bb.bbB(4).x,bb.bbB(1).x ],[bb.bbB(1).y, bb.bbB(2).y, bb.bbB(3).y, bb.bbB(4).y,bb.bbB(1).y],'g');
    %
   a = 2;
