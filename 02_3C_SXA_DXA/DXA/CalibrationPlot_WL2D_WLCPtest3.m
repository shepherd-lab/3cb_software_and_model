...
global X X2 X3 X5 Result4 X7;
global CalibrationPoints Data2 Data3 Data5 Data7;
...
MinRST=min(Data7(:,4))-0.1; % automatic choice of the scale
MaxRST=max(Data7(:,4))+0.1; 

MinHE=min(Data7(:,3))-2000;
MaxHE=max(Data7(:,3))+8000;
