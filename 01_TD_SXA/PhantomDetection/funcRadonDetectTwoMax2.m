...
function [line1,line2,OutputRadon]=funcRadonDetectTwoMax2(BW3,theta,DrawBool,option)
...
if strcmp(option,'first')|strcmp(option,'last')
    ...
    continu=true;
     while continu
        ...
        R(max(pos21(pos22)-3,1):pos21(pos22)+3,:)=0;
      ...
      R = OutputRadon;
     [R,xp] = radon(BW3,theta);
     R(pos1m(pos2m)-3:pos1m(pos2m)+3,:)=0;
     [maxi1,pos1]=max(R);
     [maxi2,pos2]=max(maxi1);
