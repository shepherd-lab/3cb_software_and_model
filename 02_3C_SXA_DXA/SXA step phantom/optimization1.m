...
global BBSPLOT Mammo pixelCm xf1 yf1 s tx ty tz rx ry rz Phantom

AutomaticMovementOn=0;
...
MoveStep=1;
uicontrol('style','pushbutton','units','normalized','position',[0.9 0.9 0.05 0.05],'string','+tx','callback','tx=tx+MoveStep;recompute;redrawGraph;');
uicontrol('style','pushbutton','units','normalized','position',[0.95 0.9 0.05 0.05],'string','-tx','callback','tx=tx-MoveStep;recompute;redrawGraph;');

uicontrol('style','pushbutton','units','normalized','position',[0.9 0.8 0.05 0.05],'string','+ty','callback','ty=ty+MoveStep;recompute;redrawGraph;');
uicontrol('style','pushbutton','units','normalized','position',[0.95 0.8 0.05 0.05],'string','-ty','callback','ty=ty-MoveStep;recompute;redrawGraph;');

uicontrol('style','pushbutton','units','normalized','position',[0.9 0.7 0.05 0.05],'string','+tz','callback','tz=tz+MoveStep;recompute;redrawGraph;');
uicontrol('style','pushbutton','units','normalized','position',[0.95 0.7 0.05 0.05],'string','-tz','callback','tz=tz-MoveStep;recompute;redrawGraph;');


uicontrol('style','pushbutton','units','normalized','position',[0.9 0.6 0.05 0.05],'string','+rx','callback','rx=rx+MoveStep;recompute;redrawGraph;');
uicontrol('style','pushbutton','units','normalized','position',[0.95 0.6 0.05 0.05],'string','-rx','callback','rx=rx-MoveStep;recompute;redrawGraph;');

uicontrol('style','pushbutton','units','normalized','position',[0.9 0.5 0.05 0.05],'string','+ry','callback','ry=ry+MoveStep;recompute;redrawGraph;');
uicontrol('style','pushbutton','units','normalized','position',[0.95 0.5 0.05 0.05],'string','-ry','callback','ry=ry-MoveStep;recompute;redrawGraph;');

uicontrol('style','pushbutton','units','normalized','position',[0.9 0.4 0.05 0.05],'string','+rz','callback','rz=rz+MoveStep;recompute;redrawGraph;');
uicontrol('style','pushbutton','units','normalized','position',[0.95 0.4 0.05 0.05],'string','-rz','callback','rz=rz-MoveStep;recompute;redrawGraph;');
