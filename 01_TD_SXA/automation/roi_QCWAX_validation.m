...
roi_grscale.xmin = round(ROI.xmin+50*k);
roi_grscale.ymin = round(ROI.ymin+120*k);
roi_grscale.xmax = round(ROI.xmin+ROI.columns-60*k);
roi_grscale.ymax = round(ROI.ymin+ROI.rows-120*k);
...
if isnan(SXAroiFit)
  ...
  kTableWAX_Negative=kTableWAX(kTableWAX(:,3)<0,3)    % AM 02282014
