...
% 4cm 50/50
 ...
 % 4cm 50/50 form manualbb_position.m
%{
 Phantom(1).mx=1123.2;Phantom(1).my= 200.98;
 Phantom(2).mx=1115   ;Phantom(2).my=335.01;
 Phantom(3).mx=877.67;Phantom(3).my=117.32;
 Phantom(4).mx=1079;Phantom(4).my=406.92;
 Phantom(5).mx=1091 ;Phantom(5).my=129.91;
 Phantom(6).mx=859.52;Phantom(6).my=425.38;
 Phantom(7).mx=851.31;Phantom(7).my=202.38;
 Phantom(8).mx=844.8;Phantom(8).my=334.17;
 %}
 %6cm 50/50
 %{
