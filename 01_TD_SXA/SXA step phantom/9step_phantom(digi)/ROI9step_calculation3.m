function  ROI9step_calculation3(film_small)
    global  bb Info flag_digital roi_xsize roi_ysize xleft middle
    %angle = 14.72 * 360 / 6.24;
    if flag_digital == true % for digital machine
        if film_small == true
           ph_angle = 17.2;%17.0;% 
        else
           ph_angle = 22.0;  %15; %20.2; 
        end    
    ...
    xright = 0.2; %addition to bottom, back
    ydown = 0.5;  % addition to bottom, y axis down
       
    mtan = tan(ydown/(1.2 + 7*step));
    ...
    bb8z = 1.2 + 4*step;
    bb9z = 1.2 + 7*step;
    x3 = xleft*(bb6z-bb3z)/bb6z;
    x9 = xleft*(bb6z-bb9z)/bb6z;
    
    bb1(1).x = -d1;                     bb1(1).y = y15+mtan*(bb3z-bb1z);    bb1(1).z = bb1z ;
    bb1(2).x = -(d1+roi_xsize);         bb1(2).y = y15+mtan*(bb3z-bb1z);    bb1(2).z = bb1z ;  
    bb1(3).x = -(d1+roi_xsize);         bb1(3).y = y05;                  bb1(3).z = bb1z ; 
    bb1(4).x = -d1;                     bb1(4).y = y05;                  bb1(4).z = bb1z ;      
    
    bb2(1).x = bb1(2).x-dd;                    bb2(1).y = y15+mtan*(bb3z-bb2z);  bb2(1).z = bb2z;
    bb2(2).x = bb1(2).x-dd-roi_xsize-middle;   bb2(2).y = y15+mtan*(bb3z-bb2z);  bb2(2).z = bb2z;
    bb2(3).x = bb1(2).x-dd-roi_xsize-middle;   bb2(3).y = y05;                bb2(3).z = bb2z;
    bb2(4).x = bb1(2).x-dd;                    bb2(4).y = y05;                 bb2(4).z = bb2z;
    
    bb3(1).x = bb2(2).x-dd;             bb3(1).y = y15;     bb3(1).z = bb3z;
    bb3(2).x = bb2(2).x-dd-roi_xsize-x3;   bb3(2).y = y15;     bb3(2).z = bb3z;
    bb3(3).x = bb2(2).x-dd-roi_xsize-x3;   bb3(3).y = y05;     bb3(3).z = bb3z;
    bb3(4).x = bb2(2).x-dd;             bb3(4).y = y05;     bb3(4).z = bb3z;
       
    bb4(1).x = -(d1+ 2*dd/3);              bb4(1).y = y05;     bb4(1).z = bb4z;
    bb4(2).x = -(d1+ 2*dd/3+roi_xsize);    bb4(2).y = y05;     bb4(2).z = bb4z;
    bb4(3).x = -(d1+ 2*dd/3+roi_xsize);    bb4(3).y = -y05;    bb4(3).z = bb4z;
    bb4(4).x = -(d1+ 2*dd/3);              bb4(4).y = -y05;    bb4(4).z = bb4z ;
    
    bb5(1).x = bb4(2).x-dd;             bb5(1).y = y05;            bb5(1).z = bb5z;
    bb5(2).x = bb4(2).x-dd-roi_xsize-middle;   bb5(2).y = y05;     bb5(2).z = bb5z;
    bb5(3).x = bb4(2).x-dd-roi_xsize-middle;   bb5(3).y = -y05;    bb5(3).z = bb5z;
    bb5(4).x = bb4(2).x-dd;             bb5(4).y = -y05;           bb5(4).z = bb5z;
    
    bb6(1).x = bb5(2).x-dd;             bb6(1).y = y05;     bb6(1).z = bb6z;
    bb6(2).x = bb5(2).x-dd-roi_xsize;   bb6(2).y = y05;     bb6(2).z = bb6z;
    bb6(3).x = bb5(2).x-dd-roi_xsize;   bb6(3).y = -y05;    bb6(3).z = bb6z;
    bb6(4).x = bb5(2).x-dd;             bb6(4).y = -y05;    bb6(4).z = bb6z;
    
    bb7(1).x = -(d1+ dd/3);              bb7(1).y = -y05;                   bb7(1).z = bb7z; 
    bb7(2).x = -(d1+ dd/3+roi_xsize);    bb7(2).y = -y05;                   bb7(2).z = bb7z;
    bb7(3).x = -(d1+ dd/3+roi_xsize);    bb7(3).y = -y15-mtan*(bb9z-bb7z);         bb7(3).z = bb7z;
    bb7(4).x = -(d1+ dd/3);              bb7(4).y = -y15-mtan*(bb9z-bb7z);         bb7(4).z = bb7z;
    
    bb8(1).x = bb7(2).x-dd;                    bb8(1).y = -y05;                bb8(1).z = bb8z;
    bb8(2).x = bb7(2).x-dd-roi_xsize-middle;   bb8(2).y = -y05;                bb8(2).z = bb8z;
    bb8(3).x = bb7(2).x-dd-roi_xsize-middle;   bb8(3).y = -y15-mtan*(bb9z-bb8z);      bb8(3).z = bb8z;
    bb8(4).x = bb7(2).x-dd;                    bb8(4).y = -y15-mtan*(bb9z-bb8z);      bb8(4).z = bb8z;
    
    bb9(1).x = bb8(2).x-dd;             bb9(1).y = -y05;     bb9(1).z = bb9z;
    bb9(2).x = bb8(2).x-dd-roi_xsize-x9;   bb9(2).y = -y05;     bb9(2).z = bb9z;
    bb9(3).x = bb8(2).x-dd-roi_xsize-x9;   bb9(3).y = -y15;     bb9(3).z = bb9z;
    bb9(4).x = bb8(2).x-dd;             bb9(4).y = -y15;     bb9(4).z = bb9z;
   
    %xleft = 0.3;
    yup =  bb3(1).z * mtan;
    
    bb0(1).x = xright;                  bb0(1).y = (1.5*roi_ysize)+yup;           bb0(1).z = 0;
    bb0(2).x = -(3*roi_xsize+middle)-xleft;     bb0(2).y = (1.5*roi_ysize)+yup;           bb0(2).z = 0;
    bb0(3).x = -(3*roi_xsize+middle)-xleft;     bb0(3).y = -(1.5*roi_ysize)-ydown;          bb0(3).z = 0;
    bb0(4).x = xright;                  bb0(4).y = -(1.5*roi_ysize)-ydown;          bb0(4).z = 0;   
   ...
   %}
                                                                  %1.5*roi_ysize+0.3
    bb.bbpos1.x = bb3(1).x-0.15;         bb.bbpos1.y = 1.5*roi_ysize+yup+0.1;        bb.bbpos1.z = bb3z-0.15;
    bb.bbpos2.x = bb2(4).x-(0.5*roi_xsize)+0.2;         bb.bbpos2.y = 1.5*roi_ysize+yup+0.1;;        bb.bbpos2.z = 1.2 + 3*step-0.25;
    bb.bbpos3.x = -(3*roi_xsize+middle)-xleft+0.15; bb.bbpos3.y = 1.5*roi_ysize+yup+0.1;        bb.bbpos3.z = 0.15;
    %x???;                                                      % -1.5*roi_ysize-0.3
    bb.bbpos4.x = bb9(4).x-0.15;         bb.bbpos4.y = -(1.5*roi_ysize+ydown+0.1);   bb.bbpos4.z = bb9z-0.15;
    bb.bbpos5.x = bb8(4).x-(0.5*roi_xsize)+0.2;         bb.bbpos5.y = -(1.5*roi_ysize+ydown+0.1);           bb.bbpos5.z = bb8z-0.25;
    bb.bbpos6.x =-(3*roi_xsize+middle)-xleft+0.15;  bb.bbpos6.y = -(1.5*roi_ysize+ydown+0.1);   bb.bbpos6.z = 0.15;
    %x???;   bb4(1).x             
    bb.bbpos7.x = bb4(1).x + 0.35;             bb.bbpos7.y = 0;                        bb.bbpos7.z = bb4z - 0.25;
    bb.bbpos8.x = xright+0.1;             bb.bbpos8.y = roi_ysize+0.1;            bb.bbpos8.z = 0.25;
    bb.bbpos9.x = xright+0.1;             bb.bbpos9.y = -roi_ysize-0.1;           bb.bbpos9.z = 0.25;
 ...
 %{
  ...
  %}
    ...
    plot([bb.bb0(1).x, bb.bb0(2).x, bb.bb0(3).x, bb.bb0(4).x,bb.bb0(1).x ],[bb.bb0(1).y, bb.bb0(2).y, bb.bb0(3).y, bb.bb0(4).y,bb.bb0(1).y]);
    %
   a = 2;
