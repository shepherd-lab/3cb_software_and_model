...
global ctrl
% %   parentdir = uigetdir('\\researchstg\aaData\Breast Studies\3C_data\RO1_3Cimages\UCSF\3C02031');
% %    bd = dir('\\researchstg\aaData\Breast Studies\3C_data\RO1_3Cimages\UCSF');
 count = 0;
 count2 = 0;
 count3 = [];
   for i=[121:121]
...
%     
%     if  ((strcmp(lower(ext), '.dcm') | isempty(ext) ) & ~isdir(name2)) %~isdir(name2)
%         fullfilename_read
