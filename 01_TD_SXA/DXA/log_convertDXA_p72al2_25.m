function I = log_convertDXA(image,mAs, kVp, Alfilter)  % to open 25kVp images
global Result
...
%  Xmin=500;Xmax=650;Ymin=1717;Ymax=1792;
 Xmin=1100;Xmax=1250;Ymin=1750;Ymax=1825;
...
%         Xmin=800;Xmax=875;Ymin=1740;Ymax=1815;
%         Xmin=800;Xmax=875;Ymin=1785;Ymax=1815;
...
%         FF_filename = '\\ming.radiology.ucsf.edu\aaDATA\Breast Studies\Tlsty_P01_data\p148al1_TT002R\airscan\p144al1_airHE3mm.63raw.png';
        FF_filename = '\\ming.radiology.ucsf.edu\aaDATA\Breast Studies\AL_SeleniaData\p42al2_cal091807\png_files\p42al2_cal50504cmHE.raw.png';
...
% %         Xmin=434;Xmax=584;Ymin=1717;Ymax=1792;   %%% same ROI ref as in small paddle
% %         Xmin=670;Xmax=820;Ymin=1717;Ymax=1792;   %%% ATTENTION ROI SHIFTED
% %         Xmin=800;Xmax=875;Ymin=1740;Ymax=1815;   %%% ATTENTION ROI Cube   
%         Xmin=800;Xmax=875;Ymin=1785;Ymax=1820;
        ROIref=image(Ymin:Ymax,Xmin:Xmax);
        signal=reshape(ROIref,1,prod(size(ROIref)));
        MEANref=nanmean(signal);
