function Periphery_calculation_cadaver()
...
% %  try
   ...
   Info.PeripheryComputed = false; 
    ...
    %X_angle = Analysis.rx + MachineParams.rx_correction/1.2; % ??? for sign of angle
     ...
     thickness_mapproj = projection_conversion(thickness_ROI);
     thickness_mapproj = medfilt2(thickness_mapproj, [5 5]);
