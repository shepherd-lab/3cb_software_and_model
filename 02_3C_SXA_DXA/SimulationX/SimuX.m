...
%%%%%%%%%%%  Anode Choice %%%%%%%%%
SimulationX.AnodeList=[{'Molybdenum18-50'},{1};{'Tungsten18-50'},{2};{'Rhodium18-50'},{3}];
...
%%%%%%%%%%% Filtration Choice %%%%%
SimulationX.FiltrationList=[{'Adipous'},{1};{'Aluminum'},{2};{'Copper'},{6};{'Glandular'},{3};{'Molybdenum'},{4};{'Rhodium'},{5};{'Copper'},{6};{'Water'},{7};{'Cortical Bone'},{8};{'Beryllium'},{9};{'PMMA'},{10};{'Poly Ethylene'},{11};{'Cesium Iodide'},{12};{'Cerium'},{13};{'Polystyrene'},{14};{'Muscle'},{15};{'PVC'},{16};{'Tin'},{17};{'Se'},{18};{'Protein'},{19};{'Fat'},{20};{'Gold'},{21}];
