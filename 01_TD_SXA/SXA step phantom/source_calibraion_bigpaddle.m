function [sort_coord] = rm1_bbspos_leftsmall()
    ...
    %res = 0.014;
    res  = Analysis.Filmresolution*0.1;
    ...
    %figure;imagesc(J_open); colormap(gray); hold on;
   ...
   %figure;imagesc(im_Z); colormap(gray); hold on;
    Zs1 = imsubtract(Z,im_Z);
    
 % figure;  imagesc(Zs1); colormap(gray); hold on;
  %{  
   ...
   % xy_centroids(1:ln,1:2) = [stats2(1:ln).Centroid(1)+690,stats2(1:ln).Centroid(2)-50]; 
    ...
    %{
      ...
      %}
       ...
       coord_Xmin = min(coord(:,1))+200; 
       coord_Xmax = max(coord(:,1)); 
       coord_Ymin = min(coord(:,2));
       coord_Ymax = max(coord(:,2));
       
       %template lines
       X_interval = (coord_Xmax-coord_Xmin)/3
       X1= coord_Xmin + X_interval/2;
       X2= coord_Xmin + 3*X_interval/2;
       X3= coord_Xmin + 5*X_interval/2;
       %X4= coord_Xmin + 7*X_interval/2;
       
       Y_interval = (coord_Ymax-coord_Ymin)/4
       Y1= coord_Ymin + Y_interval/2;
       Y2= coord_Ymin + 3*Y_interval/2;
       Y3= coord_Ymin + 5*Y_interval/2;
       Y4= coord_Ymin + 7*Y_interval/2;
       
       %line 1
        index_line1 = find(coord(:,1) < X1 & coord(:,1) > X1 -200 & coord(:,2) <Y1);
        Line1.x1 = coord(index_line1(1),1);
        Line1.x2 = coord(index_line1(2),1);
        Line1.y1 = coord(index_line1(1),2);
        Line1.y2 = coord(index_line1(2),2);
     ...
     %line 2
        index_line2 = find(coord(:,1) > X1 & coord(:,1) <X2 & coord(:,2) < Y1 );
        Line2.x1 = coord(index_line2(1),1);
        Line2.x2 = coord(index_line2(2),1);
        Line2.y1 = coord(index_line2(1),2);
        Line2.y2 = coord(index_line2(2),2);
     ...
     figure(figuretodraw); hold on; plot([Line2.x0 Line2.x2],[Line2.y0 Line2.y2],'Linewidth',1,'color','b');
      ...
      %line 3
        index_line3 = find(coord(:,1) > X2 & coord(:,1) <X3 & coord(:,2) < Y1 );
        Line3.x1 = coord(index_line3(1),1);
        Line3.x2 = coord(index_line3(2),1);
        Line3.y1 = coord(index_line3(1),2);
        Line3.y2 = coord(index_line3(2),2);
     ...
     figure(figuretodraw); hold on; plot([Line3.x0 Line3.x2],[Line3.y0 Line3.y2],'Linewidth',1,'color','b');
       ...
       %line 4
        index_line4 = find(coord(:,1) > X3 & coord(:,2) < Y1 );
        Line4.x1 = coord(index_line4(1),1);
        Line4.x2 = coord(index_line4(2),1);
        Line4.y1 = coord(index_line4(1),2);
        Line4.y2 = coord(index_line4(2),2);
     ...
     figure(figuretodraw); hold on; plot([Line4.x0 Line4.x2],[Line4.y0 Line4.y2],'Linewidth',1,'color','b');
      ...
      %line 5
        index_line5 = find(coord(:,1) > X3  & coord(:,2) > Y1 & coord(:,2) < Y2);
        Line5.x1 = coord(index_line5(1),1);
        Line5.x2 = coord(index_line5(2),1);
        Line5.y1 = coord(index_line5(1),2);
        Line5.y2 = coord(index_line5(2),2);
    ...
    %line 6
        index_line6 = find(coord(:,1) > X3 & coord(:,2) > Y2 & coord(:,2) < Y3);
        Line6.x1 = coord(index_line6(1),1);
        Line6.x2 = coord(index_line6(2),1);
        Line6.y1 = coord(index_line6(1),2);
        Line6.y2 = coord(index_line6(2),2);
     ...
     figure(figuretodraw); hold on; plot([Line6.x0 Line6.x2],[Line6.y0 Line6.y2],'Linewidth',1,'color','b');
      ...
      %line 7
        index_line7 = find(coord(:,1) > X3 & coord(:,2) > Y3 & coord(:,2) < Y4);
        Line7.x1 = coord(index_line7(1),1);
        Line7.x2 = coord(index_line7(2),1);
        Line7.y1 = coord(index_line7(1),2);
        Line7.y2 = coord(index_line7(2),2);
     ...
     figure(figuretodraw); hold on; plot([Line7.x0 Line7.x2],[Line7.y0 Line7.y2],'Linewidth',1,'color','b');
      ...
      %line 8
        index_line8 = find(coord(:,1) > X3 & coord(:,2) > Y4 );
        Line8.x1 = coord(index_line8(1),1);
        Line8.x2 = coord(index_line8(2),1);
        Line8.y1 = coord(index_line8(1),2);
        Line8.y2 = coord(index_line8(2),2);
     ...
     figure(figuretodraw); hold on; plot([Line8.x0 Line8.x2],[Line8.y0 Line8.y2],'Linewidth',1,'color','b');
      ...
      %line 9
        index_line9 = find(coord(:,1) > X2 & coord(:,1) < X3 & coord(:,2) > Y4);
        Line9.x1 = coord(index_line9(1),1);
        Line9.x2 = coord(index_line9(2),1);
        Line9.y1 = coord(index_line9(1),2);
        Line9.y2 = coord(index_line9(2),2);
     ...
     %line 10
        index_line10 = find(coord(:,1) > X1 & coord(:,1) < X2 & coord(:,2) > Y4);
        Line10.x1 = coord(index_line10(1),1);
        Line10.x2 = coord(index_line10(2),1);
        Line10.y1 = coord(index_line10(1),2);
        Line10.y2 = coord(index_line10(2),2);
     ...
     figure(figuretodraw); hold on; plot([Line10.x0 Line10.x2],[Line10.y0 Line10.y2],'Linewidth',1,'color','b');
      ...
      %line 11
        index_line11 = find(coord(:,1) < X1 & coord(:,1) > X1 -200 & coord(:,2) > Y4);
        Line11.x1 = coord(index_line11(1),1);
        Line11.x2 = coord(index_line11(2),1);
        Line11.y1 = coord(index_line11(1),2);
        Line11.y2 = coord(index_line11(2),2);
    ...
    x1_8 = sqrt((Line8.x1-Line8.x2)^2 + (Line8.y1-Line8.y2)^2)*res;
     ...
     Calibration_results{1,1} = 'x0cm_diff';
     Calibration_results{1,2} = 'y0cm_diff';
     Calibration_results{1,3} = 'source_height, cm';
     Calibration_results{1,4} = 'h_value, cm'; 
     Calibration_results{2,1} =  X0_source*Analysis.Filmresolution*0.1;
     Calibration_results{2,2} =  (Image.rows/2-Y0_source)*Analysis.Filmresolution*0.1;
     Calibration_results{2,3} = meanS;
     Calibration_results{2,4} = meanh;
    
     % Calibration_results{2,:} ={X0_source,X0_source,meanS,meanh};
     
      Excel('INIT');
      Excel('TRANSFERT',Calibration_results);
     a = 1;
