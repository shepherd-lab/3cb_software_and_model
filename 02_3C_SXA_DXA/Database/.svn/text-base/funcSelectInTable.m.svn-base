...
if iscell(table)
    ...
    if strcmp(table,'retrieveAcq')|strcmp(table,'RetrieveCommonAnalysis')|strcmp(table,'Retrievefreeformanalysis')|strcmp(table,'RetrieveSXAanalysis')|strcmp(table,'RetrieveSXAStepanalysis')|strcmp(table,'RetrieveThresholdanalysis')|strcmp(table,'RetrieveDXAanalysis')|strcmp(table,'StudySelect')|strcmpi(table,'FileOnInternalDrive')
