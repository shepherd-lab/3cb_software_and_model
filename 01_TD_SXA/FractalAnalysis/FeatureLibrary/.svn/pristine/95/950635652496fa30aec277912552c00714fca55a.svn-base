function [midpoint,p] = mask_funcFindMidPoint(outline_x,outline_y)
%
...
[C,I]=max(outline_x); %#ok<ASGLU> %find the right edge of the breast

%figure;
%plot(outline_x);
[toto,npoint]=size(outline_x); %#ok<ASGLU> %length of the outline curve
outline1_x=outline_x(1:I-1);outline1_y=outline_y(1:I-1); %upper part of the breas
outline2_y=outline_y(I+1:npoint); %lower part of the breast
