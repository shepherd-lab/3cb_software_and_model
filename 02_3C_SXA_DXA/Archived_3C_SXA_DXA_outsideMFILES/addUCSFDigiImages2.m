...
load('C:\SXADXA\SXAVersion6.3_07-29-2008\UCSFloading.mat');
...
%         end
        ...
        destination1 = [destination,folder];
        %Filename=[destination1,'\',newName,'.png'];
        Filename=[destination1,'\',name,info_dicom_blinded.AcquisitionDate,info_dicom_blinded.AcquisitionTime,'raw.png'];
        ...
        %FilenameOnDVD=[directory,'\',newName,'.png'];
        FilenameOnDVD=[directory,'\',name,info_dicom_blinded.AcquisitionDate,info_dicom_blinded.AcquisitionTime,'raw.png'];
        s=dir(FilenameOnDVD);
        fid = fopen(FilenameOnDVD);
        if fid>0
            FileSize=s.bytes;
        ...
        field{22}=[name,info_dicom_blinded.AcquisitionDate,info_dicom_blinded.AcquisitionTime,'raw.png'];
