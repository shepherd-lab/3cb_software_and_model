function  Z4ComputeBreastDensityNew(Innerline,ROI, Image)
    ...
    global Z4coef_tableBig Z4coef_tableSmall Z4coef_tableGE Result BreastMask MaskROIproj SXAAnalysis 
    ...
    % thickness = 4;
     ...
     Z4coef_table = readKvalues(Database.Name, Info.acqDate, Info.kVp, ...
...
if MachineParams.comId > 0
    DensityImage = densCorr(DensityImage, thickness_mapproj, Database.Name, MachineParams.comId);
end
