function Moffitt_3CdataLoadingSetup()
%loadDataSetup(1,1)= {uigetdir('file.start_path','select the hardrive where images are stored')};
loadDataSetup(1,1) = {uigetdir('\\researchstg\aaData\Breast Studies\3C_data\RO1_3Cimages\Moffitt\')};
...
save('\\researchstg\Working_Directory\Projects-Snap\aaSTUDIES\Breast Studies\BCSC\Analysis Code\Matlab\Versions\Development\3C SXA DXA\Moffitt3Cloading.mat','loadDataSetup');