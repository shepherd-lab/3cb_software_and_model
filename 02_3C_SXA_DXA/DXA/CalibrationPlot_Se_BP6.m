...
function CalibrationPlot_Se_BP7()
global X;
...
% figure(6);hold on;
% plot3(CalibrationPoints(:,4),CalibrationPoints(:,5),CalibrationPoints(:,2),'o','markersize',5,'markerfacecolor','r','markeredgecolor','r');
% hold on,
% f2=figure;plot(CalibrationPoints(:,4),CalibrationPoints(:,5),'o','markersize',3,'markerfacecolor','r','markeredgecolor','r');
% hold on;
% grid on;
...
densities = [23.07692308 46.15384615 57.69230 61.53846154 69.23076923 76.92307692 100];
% densities = [17.75147929 35.50295858 44.37869822 47.33727811 53.25443787 59.17159763 76.92307692];
