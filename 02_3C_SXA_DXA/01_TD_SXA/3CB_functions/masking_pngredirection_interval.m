function sxa_acq_extraction()
  global database fname Info Image BreastMask ROI
    ...
    sz1 = size(ACQIDList);
    len = sz1(1);
    dir_towrite = '\\researchstg\aaData\Breast Studies\Masking\PrelimAnalysis\UCSF\Interval\';
%     dir_towrite = '\\researchstg\aaData\Breast Studies\Masking\PrelimAnalysis\UCSF\ScreenDetected\';
