function I = log_convertDXA(image,mAs, kVp, Alfilter) %%% to open large paddle images/small paddle calibration
global Result

if  kVp == 25
    FF_filename = 'O:\Breast Studies\Tlsty_P01_data\p148al1_TT002R\airscan\p144al1_airLEA.57raw.png';
