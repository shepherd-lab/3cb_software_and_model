%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function QCAnalysis_DXAthin(RequestedAction)%GammaROI
...
heights = [1.14808; 1.88214; 2.59588; 3.23342; 3.96494; 4.67614; 5.55752; 6.27634; 7.0104];
    ...
    PhantomRefData.Draw.BorderX= round(35 * k/scale_coef); %13
    box_scale = 1;
...
switch RequestedAction
    ...
    case 'ROOT'
        QCAnalysis_DXAthin('InitDrawing');
        set(f0.handle,'WindowButtonMotionFcn','QCAnalysis_DXAthin(''Motion'')','WindowButtonDownFcn','nextpatient(1);');
        ...
        for y_index=1:3
            for x_index=1:5
              if ~x_index %==1
                ...
                count = count + 1;
                %if count < 9
                   phantom_values(y_index,x_index) =mean(mean(Image.image(ROI.Y1:ROI.Y2,ROI.X1:ROI.X2)));
...
% % %         density_vect = repmat([100 50 0],1,5);
