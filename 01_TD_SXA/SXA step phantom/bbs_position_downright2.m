  ...
  % axes;
   ...
   % xy_centroids(1:ln,1:2) = [stats2(1:ln).Centroid(1)+690,stats2(1:ln).Centroid(2)-50]; 
    ...
    Line4.y2 = coord(16,2);
     ...
     %
     Line10.x1 = coord(13,1);
     Line10.x2 = coord(15,1);
     Line10.y1 = coord(13,2);
     Line10.y2 = coord(15,2);
     ...
     %
     Line11.x1 = coord(10,1);
     Line11.x2 = coord(12,1);
     Line11.y1 = coord(10,2);
     Line11.y2 = coord(12,2);
     ...
     S = [S_1 S_2 S_3 S_4 S_5 S_6 S_7 S_8 S_9 S_10 S_11 S_12 S_13]'
     h = [h_1 h_2 h_3 h_4 h_5 h_6 h_7 h_8 h_9 h_10 h_11 h_12 h_13]'-0.21;
     %
      %
