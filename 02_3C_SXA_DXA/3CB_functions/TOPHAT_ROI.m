function tophatFiltered = TOPHAT_ROI(image);
...
tophatFiltered = imtophat(image,SE60);

% C =  imopen(original2,se);
% h = ones(50,50) / 2500;
% 
% BB = imfilter(C,h);
% tophatFiltered = original2 - BB;
% figure; imagesc(BB);colormap(gray);

%do not know why
%original3 = tophatFiltered.*breast_mask2;
original3 = tophatFiltered;
