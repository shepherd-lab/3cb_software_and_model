function structanalbreast_acq_extraction()
    ...
    [FileName,PathName] = uigetfile('\\researchstg\aadata\aaSTUDIES\Breast Studies\*.txt','Select the acquisition list txt-file ');   acqs_filename = [PathName,FileName];     %'\'
