...
function [line1,line2,OutputRadon]=funcRadonDetectTwoMax(BW3,theta,DrawBool,option)
...
if strcmp(option,'first')|strcmp(option,'last')
  ...
  line1.angle=theta(pos2);
  line1.x=pos1(pos2)-floor((size(R,1)+1)/2);
  R = OutputRadon;
  R(pos1(pos2)-4:pos1(pos2)+4,:)=0;
  [maxi21,pos21]=max(R);
  [maxi22,pos22]=max(maxi21);
...
line2.angle=theta(pos22);
line2.x=pos21(pos22)-floor((size(R,1)+1)/2);
