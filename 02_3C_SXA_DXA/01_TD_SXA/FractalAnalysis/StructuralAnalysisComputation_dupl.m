...
global ROI Outline Analysis Image StructuralAnalysis Error PreciseOutline
...
%     im2 = CurrentImage(index2);
   ...
   % figure;imagesc(FractalCurrentImage); colormap(gray);
    ...
    for k=x       
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        for indexFractalThreshold=17:17
            ...
            figure;imagesc(~gradimage);colormap(gray);hold on;
            plot((PreciseOutline.x-1)/Undersamplingfactor,(PreciseOutline.y-1)/Undersamplingfactor,'linewidth',LINEPLOTSIZE); 
