function add3C_MoffittDigiImages(patients)
...
load('O:\SRL\aaStudies\Breast Studies\3CB R01\Analysis Code\Matlab\Developers\sypks\github\shepherd-lab\3cb\00_initialization\database_loading\DATA matfiles\MOFF3Cloading');
...
i=1;
pat_dir = ['\3C02',num2str(pn, '%03i')]; 
patientID = ['3C02',num2str(pn, '%03i')]; ;
