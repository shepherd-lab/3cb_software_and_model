...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
filename='P:\Vidar Images\test\exptStepPhantomDo not know-2cmFat.tif';  
% filename='P:\Vidar Images\test\exptStepPhantomDo not know-4cm5050.tif';  
% filename='P:\Vidar Images\test\exptStepPhantomDo not know-6cmGland.tif';   
...
Phantom(9).x=0.0635;Phantom(7).y=0.90424;Phantom(7).z=0.16764;
Phantom(10).x=-0.09906;Phantom(8).y=-1.0541;Phantom(8).z=0.127;
...
% Phantom(8).mx=804;Phantom(7).my=244;
% Phantom(9).mx=804;Phantom(7).my=244;
% Phantom(10).mx=804;Phantom(7).my=244;
