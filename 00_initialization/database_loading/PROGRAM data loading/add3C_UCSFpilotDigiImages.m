function add3C_UCSFpilotDigiImages(patients)
...
load('O:\SRL\aaStudies\Breast Studies\3CB R01\Analysis Code\Matlab\Developers\sypks\github\shepherd-lab\3cb\00_initialization\database_loading\DATA matfiles\UCSFpilot3Cloading.mat');
...
i=1;
pat_dir = ['\3CB',num2str(pn, '%03i')]; 
patientID = ['3CB',num2str(pn, '%03i')]; ;
