function pilot_conversion()
 global Image hInit h_slope Info
...
%          hnd = get(0,'Children');
        ...
        if  ~(~isempty(strfind(file_names(i).name,'39')) | ~isempty(strfind(file_names(i).name,'water')) | ~isempty(strfind(file_names(i).name,'lipid')) | ~isempty(strfind(file_names(i).name,'protein')) | ~isempty(strfind(file_names(i).name,'CP'))) & ~isempty(strfind(file_names(i).name(end-2:end),'png'))
