function dicom_3C_CDupload()
 global ctrl
  ...
  parentdir = ['\\researchstg\aaData\Breast Studies\3C_data\RO1_3Cimages\UCSF\3C010',num2str(i,'%03.0f')];
  dirname_toread = parentdir;
    ...
    dirname_towritemat = [dirname_toread,'\mat_files\'];%dirname_patient
...
elseif  (strfind(view, 'ML') & (kvp == 39 | kvp == 38) & strfind(mode, 'TEC'))
    file_short = 'HEMLTEC';
elseif strfind(mode, 'MANUAL')
    if (kvp==25 & (mas>99 && mas<101)) % | mas>49 && mas<51 ) & paddle(1:4) ~= uint8([78;111;110;101]))
        file_short = 'DC';
    ...
    elseif ((kvp~= 39 | kvp ~= 38) & (paddle(1:4) == uint8([50;52;99;109]) | paddle(1:4) == uint8([49;56;99;109])) & (thickness >= 83 & time > 735500))
        file_short = ['CPLE',num2str(kvp)];
    elseif ((kvp~= 39 | kvp ~= 38) & (paddle(1:4) == uint8([50;52;99;109]) | paddle(1:4) == uint8([49;56;99;109])) & ((thickness < 83 & time > 735500) | (thickness < 70 & time < 735500)))
