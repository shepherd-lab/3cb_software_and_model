function  funcComputeStepBreastDensity(Innerline,ROI, Image)
    global Info bb Analysis params roi_values Error h_slope
   ...
   % phantom_thickness(9) = bb.bb8(1).z;
    %roi_data = [roi_values; phantom_thickness];
    index = find(roi_values(1,:)>10000&roi_values(1,:)<61000);
