...
count = 1;
  [FileName,PathName] = uigetfile('I:\Projects-Snap\aaSTUDIES\Breast Studies\Auto Dense Study\Reading List\The main Reading List\List 2\*.txt');
...
dirname_towrite =uigetdir('\\researchstg\aadata9\Breast_Studies\AutoDensityStudy\List Aim 3\UnANlyzed TAM\', ' Where do you want to put your files?');
    ...
    try
        ...
        date_driveK = datenum('20110630', 'yyyymmdd');
         ...
         date_driveUCSF=datenum('20130901', 'yyyymmdd'); 
          ...
          if (strcmp(film_identifier(1:3),'cpm') | strcmp(film_identifier(1:4),'cpuc') | strcmp(film_identifier(1:3),'har') | ~isempty(dvd_str) | strcmp(film_identifier(1:3),'not') | strcmp(film_identifier(1:3),'non')| strcmp(film_identifier(1),'0') | strcmp(film_identifier(1),'1')) | strfind(Study_id,'CPMC') %for CPMC
          ...
          elseif strcmp(film_identifier(1:3),'ucs')|| strcmp(film_identifier(1:3),'ucsf_automatic')  %for UCSF
       ...
       %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        info_dicom_blinded.PatientID = num2str(Acquisition_id);
        info_dicom_blinded.patient_id_Real = num2str(patient_id);
...
% % %         figure;imshow(XX2)
        ...
        fname_towrite=[dirname_towrite filesep name(1:end),'.dcm'];
