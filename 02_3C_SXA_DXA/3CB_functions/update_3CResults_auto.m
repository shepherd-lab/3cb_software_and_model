...
%------------- BEGIN CODE --------------
function update_3CResults_auto(density_filename, center)
...
%  maps.mask_calc = calc_segment(maps.LEPres, maps.LEatten, lesion_mask);
 MaskROI_breast = maps.breast_mask.*maps.mask_calc;
