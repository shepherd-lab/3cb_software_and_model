function pilot_conversion()
 ...
 init_pat = [];
 input_dir = '\\researchstg\aaStudies\Breast Studies\UCSF-GE Collaboration\GE_reconstruction\Breast_tomo_slices';
 output_dir = '\\researchstg\aaStudies\Breast Studies\UCSF-GE Collaboration\GE_reconstruction\Breast_tomo_slices_presentation';
...
%  _dicom = dicominfo(full_filename);
...
%           Periphery_calculation; 
             image_pres = TOPHAT_ROI(Image.image);
%             tophatFiltered = TOPHAT_ROI(Image.image);
