...
global Analysis  ROI MachineParams Image Info flag AutomaticAnalysis Database BreastMask ctrl

% Analysis.Surface=nnz(Image.BreastMask);
Analysis.Surface=nnz(BreastMask);
...
% middle = (ROI.ymax-ROI.ymin)/2; % it was in v9 version
