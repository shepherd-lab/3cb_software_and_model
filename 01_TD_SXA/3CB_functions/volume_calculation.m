function  calc_volume = volume_calculation(thick,xdir_angle)
...
%      thick_wbacky = thick + 2.3;
     thickness_ROI = create_thicknessbook(thick,xdir_angle);  %X_angle,Y_angle 
...
%     tic
    ...
    for i= 1:lenxy_up-1 
         ...
         xi = round(iy_up(i));
         yi = round(jx_up(i));
         thickness_mapreal(xi,yi) = dist_valueup^2 - (dist_valueup-min_distance*res)^2*coef;
    end 
%     t1 = toc
%     tic
    for i= 1:lenxy_low-1 
         ...
         xi = round(iy_low(i));
         yi = round(jx_low(i));
         thickness_mapreal(xi,yi) = dist_valuelow^2 - (dist_valuelow-min_distance*res)^2*coef;
    end 
%     t2 = toc
