...
if kVp==39
    [fileName, pathName]=uigetfile('.mat', 'Please select HE Flat-Field');
    FF_filename = [pathName, '\',fileName];
else
    [fileName, pathName]=uigetfile('.mat', 'Please select LE Flat-Field');
    FF_filename = [pathName, '\',fileName];
end
[fileName,pathName]=uigetfile('.mat', 'Please select dark-field image');
