function  ROI9stepZETA2_calculation2()
   % global  bb Info flag_digital roi_xsize roi_ysize xleft middle
    ...
    bb9z = 1.2 + 7*step;
     off = 0.05;    
    bb1(1).x = 3*roi_xsize - dd1-off;       bb1(1).y = 3*roi_ysize;    bb1(1).z = bb1z ;
    bb1(2).x = 2*roi_xsize - dd1-off;       bb1(2).y = 3*roi_ysize;    bb1(2).z = bb1z ;  
    bb1(3).x = 2*roi_xsize - dd1-off;       bb1(3).y = 2*roi_ysize;    bb1(3).z = bb1z ; 
    bb1(4).x = 3*roi_xsize - dd1-off;       bb1(4).y = 2*roi_ysize;    bb1(4).z = bb1z ;      
    ...
    bb0(1).x = 3*roi_xsize-0.1;           bb0(1).y = 3*roi_ysize;   bb0(1).z = 0;
    bb0(2).x = 0.1;                       bb0(2).y =3*roi_ysize;    bb0(2).z = 0;
    bb0(3).x = 0.1;                       bb0(3).y = 0;             bb0(3).z = 0;
    bb0(4).x = 3*roi_xsize-0.1;           bb0(4).y = 0;             bb0(4).z = 0;   
